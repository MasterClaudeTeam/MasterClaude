...
Read `.master-claude/team.md` (and check `.sentinel/` if Sentinel is on the team). Present, scannable:
...
If `.master-claude/team.md` doesn't exist yet, say MASTER CLAUDE isn't set up for this project yet and show the activation line: run `/master-claude`.

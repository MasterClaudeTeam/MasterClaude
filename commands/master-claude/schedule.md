...
2. **Write a logging launcher** under `.master-claude/schedule/<name>.(sh|cmd)` so the schedule line is
...
4. **Install**, verify it's registered, record it in `.master-claude/schedule/registry.md`, and tell the
